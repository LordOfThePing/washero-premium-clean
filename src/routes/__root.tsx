  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Probá de nuevo en un momento o escribinos por WhatsApp y te ayudamos.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@washero" },
      ...
      { property: "og:image", content: "https://washero.ar/icons/icon-512.svg" },
      { name: "twitter:image", content: "https://washero.ar/icons/icon-512.svg" },
    ],
    links: [
      {
        rel: "stylesheet",
